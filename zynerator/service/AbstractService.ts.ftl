...
export abstract class AbstractService<DTO extends BaseDto, CRITERIA extends BaseCriteria> {
    ...
    <#if config.groupId == "enova">
        return this.httpClient.delete<number>(this.API + dto.id);
    <#else>
    ...
    <#if config.groupId == "enova">
        return this.httpClient.post<Array<DTO>>(this.API + 'listByCriteria', criteria);
    <#else>
    ...
    public findByIdWithAssociatedList(item: DTO): Observable<DTO> {
        <#if config.groupId == "enova">
        return this.httpClient.get<DTO>(this.API + item.id);
        <#else>
    ...
    <#if config.groupId == "enova">
         return this.httpClient.post<void>(this.API , this.selections);
    <#else>
